...
class HoursWidget extends StatelessWidget {
  ...
  String getsmallpicture(String desc) {
    switch (desc) {
      ...
      case 'Thunderstorm':
        return 'assets/Design sans titre (12).png';
      case 'Drizzle':
        return 'assets/Design sans titre (12).png';
      case 'Rain':
        return 'assets/Design sans titre (12).png';
...
class HoverWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: 85,
      decoration: BoxDecoration(
        color: isDayTime ? Color(0xff4899E3) : Color.fromARGB(146, 24, 93, 136),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
            color: isDayTime
                ? Color(0xff54C1FF)
                : Color.fromARGB(255, 33, 68, 121),
            width: 2.0),
        boxShadow: [
          BoxShadow(
